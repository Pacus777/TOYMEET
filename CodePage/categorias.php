...
<body>
    ...
    <div class="catalogo-container">
        <div class="juguete-card">
            <a href="categoria_marvel.php">
                <img src="../images/pagina/marvel.png" alt="Marvel">
                <h3>Marvel</h3>
            </a>
        </div>

        <div class="juguete-card">
            <a href="categoria_transformers.php">
                <img src="../images/pagina/transformers.png" alt="Transformers">
                <h3>Transformers</h3>
            </a>
        </div>

        <div class="juguete-card">
            <a href="categoria_starwars.php">
                <img src="../images/pagina/starwars.png" alt="Star Wars">
                <h3>Star Wars</h3>
            </a>
        </div>

        <div class="juguete-card">
            <a href="categoria_funko.php">
                <img src="../images/pagina/funko.png" alt="Funko Pop">
                <h3>Funko Pop</h3>
            </a>
        </div>

        <div class="juguete-card">
            <a href="categoria_dc.php">
                <img src="../images/pagina/dc.png" alt="DC Comics">
                <h3>DC Comics</h3>
            </a>
        </div>

        <div class="juguete-card">
            <a href="categoria_otro.php">
                <img src="../images/pagina/otros.png" alt="Otros">
                <h3>Otros</h3>
            </a>
        </div>
    </div>
